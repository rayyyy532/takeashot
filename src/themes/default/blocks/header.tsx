  ...
  return (
    <>
      <header
        ...
        className="sticky top-0 z-50 bg-white/80 backdrop-blur-md shadow-sm transition-all duration-300 border-b border-gray-100"
      >
        <div
          className={cn(
            'relative'
          ...
          <div className="container">
            <div className="relative flex flex-wrap items-center justify-between lg:py-5">
              <div className="flex justify-between gap-8 max-lg:h-14 max-lg:w-full max-lg:border-b">
                {/* Brand Logo */}
                {header.brand ? (
                  header.brand.variant === 'dreamlens' ? (
                    <Link
                      href={header.brand.url || ''}
                      target={header.brand.target || '_self'}
                      className="flex items-center space-x-3 group"
                    >
                      <div className="bg-indigo-600 p-2 rounded-xl shadow-lg shadow-indigo-200 group-hover:scale-105 transition duration-300">
                        <Camera className="w-6 h-6 text-white" />
                      </div>
                      <span className="text-2xl font-extrabold text-gray-900 tracking-tight group-hover:text-indigo-600 transition duration-300">
                        {header.brand.title}
                      </span>
                    </Link>
                  ) : (
